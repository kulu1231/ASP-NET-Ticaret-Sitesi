<%@ Page Title="Spor Ayakkabıları" Language="C#" MasterPageFile="~/kullanicisablon.Master" AutoEventWireup="true" CodeBehind="spor.aspx.cs" Inherits="ticaretsitesi.spor" %>
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="ContentPlaceHolder2">
    <div class="menu">
        <ul>
            ...
            <li><a href="spor.aspx" style=" background-color:#f49140;color:#FFF;">Spor</a></li>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div id="kate">
        <ul>
            ...
            <li><a href="spor.aspx" style=" background-color:#f49140;color:#FFF;">Spor Ayakkabı</a></li>
    ...
    <div id="icerik2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [urunler] where kategori_id=13"></asp:SqlDataSource>
    </div>
</asp:Content>