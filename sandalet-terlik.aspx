<%@ Page Title="Sandalet ve Terlik Çeşitleri" Language="C#" MasterPageFile="~/kullanicisablon.Master" AutoEventWireup="true" CodeBehind="sandalet-terlik.aspx.cs" Inherits="ticaretsitesi.sandalet_terlik" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div id="kate">
        <ul>
            ...
            <li><a href="sandalet-terlik.aspx" style="background-color:#f49140;color:#FFF;">Sandalet / Terlik</a></li>
    ...
    <div id="icerik2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [urunler] where kategori_id=12"></asp:SqlDataSource>
    </div>
</asp:Content>
