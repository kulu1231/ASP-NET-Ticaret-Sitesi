<%@ Page Title="Kadın Ayakkabıları" Language="C#" MasterPageFile="~/kullanicisablon.Master" AutoEventWireup="true" CodeBehind="kadin.aspx.cs" Inherits="ticaretsitesi.kadin" %>
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="ContentPlaceHolder2">
    <div class="menu">
        <ul>
            ...
            <li><a href="kadin.aspx" style="background-color:#f49140;color:#FFF;">Kadın</a></li>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <div id="icerik2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [urunler] where kategori_id=6"></asp:SqlDataSource>
    </div>
    <div id="satinal"></div>
</asp:Content>
