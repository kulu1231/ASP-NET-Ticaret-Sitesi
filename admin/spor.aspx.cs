...
namespace ticaretsitesi.admin
{
    public partial class spor : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            bag.Open();
            OleDbCommand sorgu = new OleDbCommand("insert into urunler(resim,marka,urun_adi,fiyat,kategori_id) values('" + resim.Text + "','" + marka.Text + "','" + urun_adi.Text + "','" + fiyat.Text + "','13')",bag);
