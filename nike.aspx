<%@ Page Title="Nike Ayakkabıları" Language="C#" MasterPageFile="~/kullanicisablon.Master" AutoEventWireup="true" CodeBehind="nike.aspx.cs" Inherits="ticaretsitesi.nike" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div id="kate">
        <ul>
            ...
            <li><a href="nike.aspx" style=" background-color:#f49140;color:#FFF;">Nike</a></li>
    ...
    <div id="icerik2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [urunler] where kategori_id=9"></asp:SqlDataSource>
    </div>
</asp:Content>
