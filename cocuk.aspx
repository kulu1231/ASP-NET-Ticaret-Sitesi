<%@ Page Title="Çocuk Ayakkabıları" Language="C#" MasterPageFile="~/kullanicisablon.Master" AutoEventWireup="true" CodeBehind="cocuk.aspx.cs" Inherits="ticaretsitesi.cocuk" %>
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="ContentPlaceHolder2">
    <div class="menu">
        <ul>
            ...
            <li><a href="cocuk.aspx" style=" background-color:#f49140;color:#FFF;">Çocuk</a></li>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <div id="icerik2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [urunler] where kategori_id=1"></asp:SqlDataSource>
    </div>
</asp:Content>
