...
{
    public partial class ayrinti : System.Web.UI.Page
    {
    ...
    protected void btnSepeteEkle_Click1(object sender, EventArgs e)
    {
    ...
    protected void yorumyap_Click(object sender, EventArgs e)
    {
        ...
        OleDbConnection yorum = new OleDbConnection();
        yorum.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Server.MapPath("~/App_Data/ayakkabi.mdb");
        yorum.Open();
        OleDbCommand sorgu = new OleDbCommand("insert into yorumlar(yorum_adsoyad,yorum_icerik,tarihsaat,urun_yorum_id)values('" + TextBox1.Text + "','" + TextBox2.Text + "','"+tarih+"','"+Request.QueryString["urun"]+"')", yorum);
