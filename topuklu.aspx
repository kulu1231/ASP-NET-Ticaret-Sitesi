<%@ Page Title="Topuklu Ayakkabılar" Language="C#" MasterPageFile="~/kullanicisablon.Master" AutoEventWireup="true" CodeBehind="topuklu.aspx.cs" Inherits="ticaretsitesi.topuklu" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div id="kate">
        <ul>
            ...
            <li><a href="topuklu.aspx" style=" background-color:#f49140;color:#FFF;">Topuklu Ayakkabı</a></li>
    ...
    <div id="icerik2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [urunler] where kategori_id=14"></asp:SqlDataSource>
    </div>
</asp:Content>
