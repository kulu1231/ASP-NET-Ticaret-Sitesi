<%@ Page Title="Lescon Ayakkabıları" Language="C#" MasterPageFile="~/kullanicisablon.Master" AutoEventWireup="true" CodeBehind="lescon.aspx.cs" Inherits="ticaretsitesi.lescon" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div id="kate">
        <ul>
            ...
            <li><a href="lescon.aspx" style=" background-color:#f49140;color:#FFF;">Lescon</a></li>
    ...
    <div id="icerik2">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [urunler] where kategori_id=8"></asp:SqlDataSource>
    </div>
</asp:Content>
